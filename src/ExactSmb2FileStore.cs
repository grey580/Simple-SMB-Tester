...
{
    public class ExactSmb2FileStore : ISMBFileStore
    {
        private const int BytesPerCredit = 65536;

        private ExactSmb2Client m_client;
        private uint m_treeID;
        private bool m_encryptShareData;

        public ExactSmb2FileStore(ExactSmb2Client client, uint treeID, bool encryptShareData)
        {
            m_client = client;
            m_treeID = treeID;
